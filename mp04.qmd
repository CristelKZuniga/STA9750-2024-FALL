...
1.  Joined CUNY in January 2009

2.  Retired from CUNY in November 2024
...
income_table <- data.frame(
  Plan = c("TRS", "ORP"),
  First_Month_Retirement_Income = c(round(trs_income, 2), round(orp_income, 2)) # Replace these with your actual results
)
